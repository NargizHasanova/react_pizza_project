                      ...
                      <div className="logmod__tab lgm-1">
                        <div className="logmod__heading">
                          <span className="logmod__heading-subtitle">
                            Введите свои данные <strong>для регистрации</strong>
                          </span>
                        </div>
                        <div className="logmod__form">
                          ...
                          <form className="simform" onSubmit={submitSignUpForm}>
                              ...
                              <div className="input string optional">
                                ...
                                <span className="hide-password">
                                  <i
                                    ...
                                    className={
                                      !showPassword
                                        ? 'fas fa-eye close-eye'
                                        : 'fas fa-eye-slash close-eye'
                                    }
                                  ></i>
                                </span>
                              </div>
                            ...
                            <div className="simform__actions">
                              <span
                                className={`simform__actions-sidetext ${
                                  !acceptTerms &&
                                  !acceptTermsError &&
                                  'errorMessage'
                                }`}
                              >
                                ...
                                <i
                                  className={`fas fa-asterisk acceptTermsWarning ${
                            ...
                            <div className="simform__actions">
                              <span className="simform__actions-sidetext">
                                ...
                                <div className="forget-password-message">
                                  На ваш email будет выслана ссылка для сброса
                                  вашего пароля
                                </div>
                              </span>
                              <button className="sumbit" type="submit">
