            ...
            return (
                <div key={id} className="pizza-block">
                    ...
                    <div className="pizza-block__selector">
                        <ul>
                            <li onClick={() => activateCrust(id)}
                                className={original ? "active" : ""}>{crust[0]}</li>
                            <li onClick={() => activateCrust2(id)}
                                className={thin ? "active" : ""}>{crust[1]}</li>
                        </ul>
                        <ul>
                            <li onClick={() => activateSize(id)}
                                className={classNames({
                                    active: sizeSelect.small === true,
                                    disabled: size[0] == false
                                })}
                            >26см</li>
                            <li onClick={() => activateSize1(id)}
                                className={classNames({
                                    active: sizeSelect.medium === true,
                                    disabled: size[1] == false
                                })}
                            >30см</li>
                            <li onClick={() => activateSize2(id)}
                                className={classNames({
                    ...
                    <div className="pizza-block__bottom">
                        <div className="pizza-block__price"> {price} AZN</div>
                        <div onClick={() => increase(id, item)} className="button button--outline button--add">
                            <svg
                                width="12"
                                height="12"
                                viewBox="0 0 12 12"
